...
const benefits: Array<BenefitType> = [
    {
        ...
        description: "Top of the line equipment and facilities."
    },
    {
...
const Benefits = ({setSelectedPage}: Props) => {
  ...
  return (
    <section
        id="benefits"
        className="mx-auto min-h-full bg-white w-5/6 py-20"
    >
        <motion.div
        ...
        >
            ...
            {/* Benefits */}
            <motion.div 
                className="lg:flex items-start items-stretch justify-between gap-8 mt-5"
                initial="hidden"
                whileInView="visible"
                viewport={{ once:true, amount: 0.5}}
                variants={container}
